...
public class RagConfiguration {
    ...
    @Bean
    SimpleVectorStore simpleVectorStore(OllamaEmbeddingModel ollamaEmbeddingModel) {
    ...
    private File getVectorStoreFile() {
        ...
        String absolutetPath = path.toFile().getAbsolutePath() + "/" + vectorStoreName;
        return new File(absolutetPath);
    }
}
