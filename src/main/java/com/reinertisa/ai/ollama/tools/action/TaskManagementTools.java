...
public class TaskManagementTools {
    ...
    public TaskResult updateTaskStatus(Long taskId, TaskStatus status) {
        ...
        return new TaskResult(taskId, updatedTask.title(), status.toString(), updatedTask.assignee(),
    ...
    public TaskResult assignTask(Long taskId, String newAssignee) {
        ...
        Task updatedTask = new Task(existingTask.id(), existingTask.title(), existingTask.description(),
                newAssignee, existingTask.status());
        tasks.put(taskId, updatedTask);
